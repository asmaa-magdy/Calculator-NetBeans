/*
 * To change this license header, choose License Headers in Project Properationerties.
 * To change this template file, choose Tools | Templates
 * and operationen the template in the editor.
 */
...
public class Calculator extends javax.swing.JFrame { 
    ...
    Operations operation = new Operations() {
     ...
     static double result, counter = 0; /**
      * counter to check if the statement contained more than one operator
      */
     boolean plus = false, minus = false, divide = false, multiply = false, check = false;
    // ArrayList <String> for_number = new ArrayList<String>();
    // for_number.add();
    // for_number.get();
    // for_number.remove();
    ...
    /**
     * this function is to check which operator is ON 
     * and use it in the previous operation
     * @return the value of the operation
     */
    public double OperateAgain(){
        if(plus == true){
            operation = new Plus();
            plus = false;
            return Double.parseDouble(operation.getValueOf(firstNumber, secondNumber));
        }
        if(minus == true){
            operation = new Minus();
            minus = false;
        ...
        if(divide == true){
           ...
           // jTextField1.setText(operation.getValueOf(firstNumber, secondNumber));
            divide = false;
         return Double.parseDouble(operation.getValueOf(firstNumber, secondNumber));
        }
        if(multiply == true){
    ...
    private void initComponents() {
        ...
        jButton12.setText("Edit      View      Help!");
...
//        jTextField1.setText(jTextField1.getText() + jButton11.getText());
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        // TODO add your handling code here:
         jTextField1.setText(PM.getValueOf(jTextField1.getText()));
    ...
    public static void main(String args[]) {
        ...
        //<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (operationtional) ">
